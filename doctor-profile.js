(() => {
  ...
  const reviewsSection = /^https:\/\/prodoctorov\.ru\//.test(doctor.reviewsUrl || '') ? '<section class="detail-section detail-pale" id="doctor-reviews"><div class="shell detail-editorial"><div><span class="eyebrow">Мнения пациентов</span><h2>Отзывы о враче</h2></div><div class="detail-copy"><a class="btn" href="' + escape(doctor.reviewsUrl) + '" target="_blank" rel="noopener">Читать отзывы на ПроДокторов <span aria-hidden="true">↗</span></a></div></div></section>' : '';
